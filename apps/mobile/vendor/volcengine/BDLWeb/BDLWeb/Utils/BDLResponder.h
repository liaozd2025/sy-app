...
@interface BDLResponder : NSObject
...
+ (nullable UIViewController *)topViewControllerForController:(UIViewController *)viewController;
+ (nullable UIViewController *)topViewControllerForResponder:(UIResponder *)responder;
