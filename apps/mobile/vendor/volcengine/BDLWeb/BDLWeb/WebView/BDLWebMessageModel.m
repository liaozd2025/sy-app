...
@implementation BDLWebMessageModel
...
@implementation BDLWebMsgCreatePlayerModel

@end

@implementation BDLWebMsgStateChangeModel

@end

@implementation BDLWebMsgPlayerStateChangeModel

@end

@implementation BDLWebMsgMediaLoadFinishedModel
...
@implementation BDLWebMsgConfigWebView

- (instancetype)init {
    self = [super init];
    if (self) {
        _isInBDLEnv = YES;
        _keepPlayWhenPageHide = YES;
    }
    return self;
}
