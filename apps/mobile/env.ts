...
const BUNDLE_IDS = {
  development: 'com.yixiang.health.development',
  preview: 'com.yixiang.health.preview',
  production: 'com.yixiang.health',
} as const;
...
const SCHEMES = {
  development: 'yixiangHealth',
  preview: 'yixiangHealth.preview',
  production: 'yixiangHealth',
} as const;
